...
func (*Dapmsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{0}
}
...
func (*GetBlockchainInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{1}
}
...
func (*ReturnBlockchainInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{2}
}
...
func (*GetBlocks) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{3}
}
...
func (*ReturnBlocks) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{4}
}
...
func (*GetCommonBlocks) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{5}
}
...
func (*ReturnCommonBlocks) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{6}
}
...
func (*GetPeerList) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{7}
}
...
func (*ReturnPeerList) Descriptor() ([]byte, []int) {
	return fileDescriptor_dapmsg_d77483839f0b892c, []int{8}
}
...
func init() {
	proto.RegisterFile("github.com/dappley/go-dappley/network/pb/dapmsg.proto", fileDescriptor_dapmsg_d77483839f0b892c)
}

var fileDescriptor_dapmsg_d77483839f0b892c = []byte{
	// 539 bytes of a gzipped FileDescriptorProto
	,
}
