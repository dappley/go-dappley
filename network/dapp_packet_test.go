...
func TestDappPacket_ExtractDappPacketFromRawBytes(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "CorrectData",
			input: []byte{0x7e, 0x7e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5, 0xF, 0x10, 0x1, 0x2, 0x3, 0x4, 0x5},
			retData: &DappPacket{
				[]byte{0x7e, 0x7e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5, 0xF, 0x10},
				[]byte{1, 2, 3, 4, 5},
			},
			retErr: nil,
		},
		{
			...
			input: []byte{0x7e, 0x7e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5, 0xF, 0x10, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6},
			retData: &DappPacket{
				[]byte{0x7e, 0x7e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5, 0xF, 0x10},
				[]byte{1, 2, 3, 4, 5},
			},
		...
		},
		{
			...
			input:   []byte{0x7e, 0x7e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x5, 0xF, 0x10, 0x1, 0x2, 0x3, 0x4},
			retData: nil,
			retErr:  ErrLengthTooShort,
		},
		{
