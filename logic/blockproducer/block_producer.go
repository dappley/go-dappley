...
func (bp *BlockProducer) Getblockchain() *lblockchain.Blockchain {
	if bp.bm == nil {
		return nil
	}
...
func (bp *BlockProducer) prepareBlock(deadlineInMs int64) *lblockchain.BlockContext {
...
func (bp *BlockProducer) collectTransactions(utxoIndex *lutxo.UTXOIndex, parentBlk *block.Block, deadlineInMs int64) ([]*transaction.Transaction, *scState.ScState) {
