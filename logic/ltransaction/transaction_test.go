...
func TestVerifyNoCoinbaseTransaction(t *testing.T) {
	...
	tests := []struct {
		...
		{"ltransaction.Sign invalid", transaction.Transaction{nil, txin1, txout, common.NewAmount(0), common.NewAmount(0), common.NewAmount(0)}, wrongPrivKeyByte, errors.New("Transaction: ID is invalid")},
	}
