...
import (
	...
	"errors"
	"fmt"
	"github.com/dappley/go-dappley/crypto/cryptobyte"
	cryptobyte_asn1 "github.com/dappley/go-dappley/crypto/cryptobyte/asn1"
	"github.com/dappley/go-dappley/crypto/x509/pkix"
	"io"
	"math/big"
	"net"
	"net/url"
...
func parsePublicKey(algo PublicKeyAlgorithm, keyData *publicKeyInfo) (interface{}, error) {
	...
	case ECDSA:
		...
		x, y := unmarshal(namedCurve,asn1Data)
		if x == nil {
