...
func TestGenerateKeyPairByPrivateKey(t *testing.T) {
	...
	expectedPrivKey, err := secp256k1.HexToECDSAPrivateKey("bb23d2ff19f5b16955e8a24dca34dd520980fe3bddca2b3e1b56663f0ec1aa7e")
	assert.Nil(t, err)
	assert.Equal(t, *expectedPrivKey, keyPair.privateKey)
	...
	assert.Equal(t, pubKey, keyPair.publicKey)
	expectedPrivKey, err = secp256k1.HexToECDSAPrivateKey("23d2ff19f5b16955e8a24dca34dd520980fe3bddca2b3e1b56663f0ec1aa7e")
	assert.Nil(t, err)
	assert.Equal(t, *expectedPrivKey, keyPair.privateKey)
