...
type UtxoKeyList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UtxoKey [][]byte `protobuf:"bytes,1,rep,name=utxoKey,proto3" json:"utxoKey,omitempty"`
}

func (x *UtxoKeyList) Reset() {
	*x = UtxoKeyList{}
	if protoimpl.UnsafeEnabled {
...
func (x *UtxoKeyList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UtxoKeyList) ProtoMessage() {}

func (x *UtxoKeyList) ProtoReflect() protoreflect.Message {
	mi := &file_utxo_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UtxoKeyList.ProtoReflect.Descriptor instead.
func (*UtxoKeyList) Descriptor() ([]byte, []int) {
	return file_utxo_proto_rawDescGZIP(), []int{1}
}

func (x *UtxoKeyList) GetUtxoKey() [][]byte {
	if x != nil {
		return x.UtxoKey
	}
	return nil
...
var file_utxo_proto_rawDesc = []byte{
	...
	0x78, 0x6f, 0x70, 0x62, 0x22, 0xad, 0x01, 0x0a, 0x04, 0x55, 0x74, 0x78, 0x6f, 0x12, 0x16, 0x0a,
	...
	0x72, 0x61, 0x63, 0x74, 0x22, 0x27, 0x0a, 0x0b, 0x55, 0x74, 0x78, 0x6f, 0x4b, 0x65, 0x79, 0x4c,
	0x69, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x75, 0x74, 0x78, 0x6f, 0x4b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0c, 0x52, 0x07, 0x75, 0x74, 0x78, 0x6f, 0x4b, 0x65, 0x79, 0x62, 0x06, 0x70,
...
var file_utxo_proto_goTypes = []interface{}{
	...
	(*UtxoKeyList)(nil), // 1: utxopb.UtxoKeyList
}
