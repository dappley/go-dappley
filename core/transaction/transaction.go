...
// IsContractGen returns true if the transaction is generated by contract execution; false otherwise
func (tx *Transaction) IsContractGen() bool {
	return tx.Type == TxTypeContractGen
}
