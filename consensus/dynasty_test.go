...
func TestDynasty_NewDynasty(t *testing.T) {
	dynasty := CreateNewDynasty([]string{}, DefaultMaxProducersIfNoProducersGiven, DefaultTimeBetweenBlockIfNoneGiven)
...
func TestDynasty_AddProducer(t *testing.T) {
	...
	for _,tt := range tests {
		t.Run(tt.name, func(t *testing.T){
			dynasty:= CreateNewDynasty([]string{}, tt.maxPeers, DefaultTimeBetweenBlockIfNoneGiven)
...
func TestDynasty_GetMinerIndex(t *testing.T) {
	...
	for _,tt := range tests {
		t.Run(tt.name, func(t *testing.T){
			dynasty:= CreateNewDynasty(tt.initialProducers, len(tt.initialProducers) , DefaultTimeBetweenBlockIfNoneGiven)
...
func TestDynasty_ProducerAtATime(t *testing.T) {
	...
	for _,tt := range tests {
		t.Run(tt.name, func(t *testing.T){
			dynasty:= CreateNewDynasty(producers, len(producers), DefaultTimeBetweenBlockIfNoneGiven)
